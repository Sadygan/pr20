  ...
  def create
    ...
    respond_to do |format|
      if @container.save
        format.html { redirect_to [@project, @container], notice: 'Container was successfully created.' }
  ...
  private
    ...
    def container_params
      params.require(:container).permit(:filetype, :project_id, :image, :table_specific_id)
    end
