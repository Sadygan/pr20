class FactoriesController < ApplicationController
  ...
  private
    ...
    def factory_params
      params.require(:factory).permit(:brend, :web, :autirification, :style, :line_product, :catalog, :price, :discount, :additional_discount, :delivery_term, :note, :table_specific)
    end
end
